...
public class Employee extends Users{
    ...
    public String seleccionarTipoEmpleado(int opc){
        if ( opc == 1){
            String gerente = String.valueOf(TypeEmployee.GERENTE);
            return gerente;
        } else if (opc == 2) {
            String supervisor = String.valueOf(TypeEmployee.SUPERVISOR);
            return supervisor;
        }else if (opc == 3){
            String cajero = String.valueOf(TypeEmployee.CAJERO);
            return cajero;
        }else {
